...
export const _metadata = {
	POST: {
		...
		description:
			'Resume reconciliation for multiple suspended FluxCD resources in a single request. Per-resource permission checks are applied.',
		tags: ['Flux'],
		request: {
			body: {
				content: {
