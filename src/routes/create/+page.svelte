...
<div class="space-y-8 p-8">
	...
	<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
		{#each templates as template}
			...
			>
				<div class="mb-4 flex size-12 items-center justify-center rounded-xl bg-blue-500/10 text-blue-500 transition-colors group-hover:bg-blue-500 group-hover:text-white">
		...
		>
			<div class="mb-4 flex size-12 items-center justify-center rounded-xl bg-muted text-muted-foreground transition-all group-hover:bg-blue-500/10 group-hover:text-blue-500">
				<Plus size={24} />
			</div>

			<h3 class="mb-2 text-lg font-bold">Custom Resource</h3>
			<p class="mb-6 flex-1 text-sm text-muted-foreground">
				Start with a blank YAML manifest for any FluxCD or Kubernetes resource.
			</p>

			<div class="flex items-center gap-2 text-sm font-semibold text-muted-foreground group-hover:text-blue-500">
				Advanced Mode
				<ArrowRight size={16} class="transition-transform group-hover:translate-x-1" />
			</div>
		</a>
